//
// Heart and Brain SpikerBox based P300 experiment 
// Heart and Brain version 0.53 based on ATMEGA32u4 (Leonardo)
// 
// V1.0
// Backyard Brains
// Stanislav Mircic
...
void setup(){ 
  ...
  //Inputs for events 
  pinMode(SPEAKER_OUTPUT, OUTPUT); //PD7

  pinMode(CARRIER_PIN, OUTPUT); //PC7
